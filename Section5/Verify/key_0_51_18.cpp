...
void impose ( u64 & key0, u64 & key1, u64 & N0, u64 & N1, int v )
{
    ...
    if ( id[0] )
    x[76] = 1 ^ x[12]*k[12] ^ x[12]*k[76] ^ x[12] ^ x[54]*k[54] ^ x[54]*k[118] ^ x[54] ^ x[118] ^ k[12]*k[76] ^ k[12] ^ k[54]*k[118] ^ k[54] ^ k[76] ^ k[118] ^ 1;
    ...
    if ( id[6] )
    x[30] = 1 ^ x[39] ^ x[41] ^ x[48] ^ x[94]*k[30] ^ x[103]*k[39] ^ x[105] ^ x[112] ^ x[122]*k[58] ^ x[122] ^ k[30]*k[94] ^ k[39]*k[103] ^ k[39] ^ k[41] ^ k[48] ^ k[58]*k[122] ^ k[58] ^ k[94] ^ k[103] ^ k[105] ^ k[112] ^ 1;

    if ( id[7] )
    x[23] = x[47] ^ x[54] ^ x[57] ^ x[87]*k[23] ^ x[87] ^ x[111] ^ x[118] ^ x[121]*k[57] ^ x[121] ^ k[23] ^ k[47] ^ k[54] ^ k[57] ^ k[111] ^ k[118];

    if ( id[8] )
    x[32] = 1 ^ x[23] ^ x[30] ^ x[34] ^ x[39] ^ x[48] ^ x[51] ^ x[87]*k[23] ^ x[94]*k[30] ^ x[96]*k[32] ^ x[98] ^ x[103]*k[39] ^ x[112] ^ x[115] ^ x[122]*k[58] ^ x[122] ^ k[23]*k[87] ^ k[23] ^ k[30]*k[94] ^ k[32]*k[96] ^ k[32] ^ k[34] ^ k[39]*k[103] ^ k[39] ^ k[48] ^ k[58]*k[122] ^ k[58] ^ k[87] ^ k[94] ^ k[96] ^ k[98] ^ k[103] ^ k[112] ^ 1;
