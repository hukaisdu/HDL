...
void impose ( u64 & key0, u64 & key1, u64 & N0, u64 & N1 )
{
    ...
    for ( int i = 0; i < 64; i++ )
     ...
     x[34]  = x[41] ^ x[98] ^ x[105] ^ k[34] ^ k[41] ^ k[98] ^ k[105] ^ 1;
     ...
     x[32]  = 1 ^ x[23] ^ x[30] ^ x[34] ^ x[39] ^ x[48] ^ x[87]*k[23] ^ x[94]*k[30] ^ x[96]*k[32] ^ x[98] ^ x[103]*k[39] ^ x[112] ^ x[122]*k[58] ^ x[122] ^ k[23]*k[87] ^ k[23] ^ k[30]*k[94] ^ k[32]*k[96] ^ k[32] ^ k[34] ^ k[39]*k[103] ^ k[39] ^ k[48] ^ k[58]*k[122] ^ k[58] ^ k[87] ^ k[94] ^ k[96] ^ k[98] ^ k[103] ^ k[112] ^ 1;
